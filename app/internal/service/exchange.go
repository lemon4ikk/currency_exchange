...
func NewExchangeService(s *sql.DB) *ExchangeService {
	return &ExchangeService{
		exchangeDB: s,
	}
}

func (e *ExchangeService) AllExchange(w http.ResponseWriter, r *http.Request) ([]templates.ExchangeRate, templates.Msg) {
...
func (e *ExchangeService) CodeExchange(w http.ResponseWriter, r *http.Request) ([]templates.ExchangeRate, templates.Msg) {
	c := r.PathValue("code")
	var exchange []templates.ExchangeRate
	var m templates.Msg
...
func (e *ExchangeService) NewExchange(w http.ResponseWriter, r *http.Request) ([]templates.ExchangeRate, templates.Msg) {
	var b, t int
	var m templates.Msg
...
func (e *ExchangeService) UpdateExchange(w http.ResponseWriter, r *http.Request) ([]templates.ExchangeRate, error) {
