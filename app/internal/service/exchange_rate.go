...
func NewExchangeRateService(db *sql.DB) *ExchangeRateService {
	return &ExchangeRateService{
		exchangeRateDB: db,
	}
}

func (e *ExchangeRateService) Exchange(w http.ResponseWriter, r *http.Request) ([]templates.ExchangeRateAmount, templates.Msg) {
